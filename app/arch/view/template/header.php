		...
		<body>
   		...
   		<div style = "position: absolute; float: top; left: 0px; width: 100%; background-color: rgba(100, 252, 252, 0.4);">
			<h1> <?php echo $GLOBALS['sitename']; ?> </h1> 
			<h4> <?php echo $GLOBALS['sitetagline']; ?> </h4> 
		</div>
		
		<div style = "position: absolute; right: 0px; width: 140px; background-color: rgba(100, 252, 252, 0.4);">
